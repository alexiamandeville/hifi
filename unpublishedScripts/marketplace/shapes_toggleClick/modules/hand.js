...
Hand = function (side) {
    ...
    var handController,
		...
		isXButtonPressed,
		isXButtonClicked = false,
		wasXButtonClicked = false,
        GRIP_ON_VALUE = 0.99,
        GRIP_OFF_VALUE = 0.95,
    ...
    function update() {
		...
		// X Button pressed
	    isXButtonPressed = Controller.getValue(xButton);
		
		
		//X Button Clicked
		if (isXButtonPressed && !wasXButtonClicked) {
            isXButtonClicked = !isXButtonClicked;
        }
		
		wasXButtonClicked = isXButtonPressed; //Save Down State of X Button
